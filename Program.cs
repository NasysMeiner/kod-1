...
namespace hw4._4
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            DrawBag(map , playerPositionY, playerPositionX, ref bag);
            DrawSymbolPlayer(playerPositionY, playerPositionX);
        ...
        static void DrawBag(char[,] map ,int playerPositionY, int playerPositionX, ref string bag)
        {
        ...
        static void DrawSymbolPlayer(int playerPositionY, int playerPositionX)
        {
            Console.SetCursorPosition(playerPositionX, playerPositionY);
            Console.WriteLine("!");
        }
