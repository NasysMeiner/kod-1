...
namespace hw6._3
{
    ...
    class DataBase
    {
        ...
        {
                Console.WriteLine($"ID {_players[_numberId].ShowPlayersId} удалён.");
        ...
        private void Ban()
        {
            ...
            SearchId();
            _players[_numberId].Status(condition);
            Console.ReadLine();
            Console.Clear();                 
        }
    ...
    class Player
    {
        ...
        public void Status(bool condition)
        {
            ...
            else if (_stateOnTheServer == condition && condition == true)
            {
